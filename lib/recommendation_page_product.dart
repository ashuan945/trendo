...
class RecommendationPageProduct extends StatefulWidget {
  const RecommendationPageProduct({super.key});

  @override
  State<RecommendationPageProduct> createState() => _RecommendationPageProductState();
}

class _RecommendationPageProductState extends State<RecommendationPageProduct> {
  bool isLoading = true;
  ...
  Future<void> fetchInsights() async {
    try {
      final response = await http.get(
        Uri.parse('https://keugh3ttkl.execute-api.us-east-1.amazonaws.com/dev/insights?type=product'),
      );
