...
class RecommendationPageMonthly extends StatefulWidget {
  const RecommendationPageMonthly({super.key});

  @override
  State<RecommendationPageMonthly> createState() => _RecommendationPageMonthlyState();
}

class _RecommendationPageMonthlyState extends State<RecommendationPageMonthly> {
  bool isLoading = true;
  ...
  Future<void> fetchInsights() async {
    try {
      final response = await http.get(
        Uri.parse('https://keugh3ttkl.execute-api.us-east-1.amazonaws.com/dev/insights?type=monthly'),
      );
