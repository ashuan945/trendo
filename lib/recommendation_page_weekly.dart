...
class RecommendationPageWeekly extends StatefulWidget {
  const RecommendationPageWeekly({super.key});

  @override
  State<RecommendationPageWeekly> createState() => _RecommendationPageWeeklyState();
}

class _RecommendationPageWeeklyState extends State<RecommendationPageWeekly> {
  bool isLoading = true;
  ...
  Future<void> fetchInsights() async {
    try {
      final response = await http.get(
        Uri.parse('https://keugh3ttkl.execute-api.us-east-1.amazonaws.com/dev/insights?type=weekday'),
      );
